  ...
  stream.on('directory', async (resp, dirPath) => {
    ...
    await new Promise((resolve) => {
      fs.readdir(directoryPath, (err, files) => {
        ...
        htmlResponse
          += '<section class="bg-blue-50 py-6 px-4 flex-1 overflow-y-auto"><h3 class="text-xl font-sans font-medium mb-4 text-slate-500">- Lelegoyeng Directory List</h3><ul class="flex flex-col space-y-4">';
        files.forEach((file) => {
